...
import ActualizarCategorias from './componentes/categorias/ActualizaCategorias';
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/actualizar-categoria/:idCategoria" exact element= {<ActualizarCategorias/>}/>
